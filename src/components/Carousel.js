...
class Carousel extends React.Component {
  ...
  renderControls(properties) {
    ...
    const controlPreClassName = "carousel-control-prev";
    const controlNextClassName = "carousel-control-next";
    ...
    return [
      ...
      (wrap || activeIndex !== count - 1) && (
        <a
          key="next"
          className={controlNextClassName}
